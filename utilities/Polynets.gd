...
static func drawwaterlevelmesh(waterflowlevelvectors, nodepoints):
	var arraymesh = ArrayMesh.new()
	var surfaceTool = SurfaceTool.new()
	surfaceTool.begin(Mesh.PRIMITIVE_TRIANGLES)
