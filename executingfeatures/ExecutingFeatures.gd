...
#https://github.com/goatchurchprime/tunnelvr_cave_data/tree/main/cavedata/firstarea
	...
	var err = http.request(HTTPClient.METHOD_GET, "/repos/goatchurchprime/abdulsdiodedisaster/contents/junk", headers) 
...
#		https://raw.githubusercontent.com/goatchurchprime/abdulsdiodedisaster/master/junk/madebyapi.txt
